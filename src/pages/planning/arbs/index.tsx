            ...
            <ChildBox>
              <article>
                ...
                <Type paragraph>
                  ...
                  supply due to a variety of factors, including population
                  growth; increased regulatory requirements; changes in Central
                  Valley Project (CVP) operations; inadequate infrastructure;
                  and lack of interagency planning necessary to address emerging
                  climate change conditions, and increasingly intense and more
                  frequent extreme events (droughts and floods).
                </Type>
                <Type paragraph>
                  The U.S. Department of the Interior, Bureau of Reclamation
                  (Reclamation) recently completed the Sacramento and San
                  Joaquin Rivers Basin Study (SSJRBS) (March 2016). The SSJRBS
                  forecasts the potential impacts of climate change on water
                  supply, water quality and critical habitat within California’s
                  Central Valley. The 60,000 square mile study area for the
                  SSJRBS encompasses all main tributaries within the Central
                  Valley as well as the Sacramento-San Joaquin Delta (Delta),
                  the largest estuary on the west coast of North America. The
                  SSJRBS outlines potential impacts over a range of possible
                  future climate conditions on various natural resources and
                  presents portfolios of broad adaptive strategies for
                  consideration by water agencies and other interests.
                </Type>
                <Type paragraph>
                  The purpose of the American River Basin Study (ARBS or Study)
                  is to refine and update the data, tools, analyses, and
                  adaptation strategies in the SSJRBS for the American River
                  Basin. Specifically, the ARBS will update the SSJRBS to
                  reflect basin-specific, integrated water management strategies
                  to improve regional water supply reliability within the
                  American River Basin, while improving the Reclamation’s
                  flexibility in operating Folsom Reservoir to meet flow and
                  water quality standards and protect endangered fishery species
                  in the lower American River.
                </Type>
                <Type paragraph>
                  The ARBS will present a holistic examination of water
                  management practices to address significant recent changes in
                  conditions and regulatory requirements related to the CVP and
                  regional water management, including Biological Opinions for
                  endangered fishery species protection, the State’s Sustainable
                  Groundwater Management Act, and the science of climate change.
                </Type>
                <Spacing />
                ...
                <Type paragraph>
                  ...
                  strategies, building on those identified in the SSJRBS. The
                  ARBS will:
                </Type>
                <ul>
                  <TypeBullet>
                    Further refine an assessment of water supplies and demands
                    for the American River Basin over the data developed for the
                    SSJRBS.
                  </TypeBullet>
                  <TypeBullet>
                  ...
                  <TypeBullet>
                    ...
                    flexibility for Reclamation’s Folsom Dam and Reservoir to
                ...
                <Type paragraph>
                  The ARBS will address the following specifically required
                ...
                <ul>
                  <TypeBullet>
                    ...
                    relating to climate change as defined in Section 9503(b)(2)
                  ...
                  <TypeBullet>
                    ...
                    realities and other impact identified in Section 9503(b)(3)
                    of the SECURE Water Act, including the ability to deliver
                    water; hydroelectric power generation; recreation; fish and
                    wildlife habitat; applicable species listed as endangered,
                    threatened, or candidate species and/or designated critical
                    habitat under the Endangered Species Act of 1973; water
                    quality issues (including salinity levels); flow and water
                    dependent ecological resiliency; and flood control and/or
                    management.
                  </TypeBullet>
                  <TypeBullet>
                ...
                <Type paragraph>
                  ...
                  committed to pursuing integrated water management solutions
                ...
                <Type paragraph>
                  ...
                  Sacramento River. Figure 1-1 shows the Study Area – the
                  American River Basin – that is bounded by the Bear River to
                  the north, the Cosumnes River to the south, the Sierra Nevada
                  mountain range to the east, and the Feather and Sacramento
                  Rivers to the west. The Study Area encompasses two parts:
                </Type>
                <ul>
                  <TypeBullet>
                    <strong>American River Watershed</strong> – This watershed
                    covers 2,140 square miles from Sacramento to the peaks of
                    the northern Sierra Nevada mountains west of Lake Tahoe.
                    Areas outside of the watershed that are served by Study
                    Partners with American River water are also included in the
                    Study Area.
                  </TypeBullet>
                  <TypeBullet>
                    <strong>North and South Groundwater Subbasins</strong> –
                    These two groundwater basins in the west side of the Study
                    area are separated by the American River, and their eastern
                    boundary represents the approximate edge of the alluvial
                    basin, where little or no groundwater flows into or out of
                    the groundwater basins from the Sierra Nevada basement rock.
                    In addition to surface water from the American River, local
                    water agencies use groundwater for their water supply needs.
                  </TypeBullet>
                </ul>
                ...
                <Type paragraph>
                  ...
                  ARBS development process. Stakeholders and interested members
                  of the public can be notified of public meetings/workshops via
                  the ARBS Web site, or elect to sign up for email notifications
                  here.{' '}
                  <Link href="mailto:brickards@pcwa.net">
                    “Request to join ARBS Stakeholder distribution list.”
                  </Link>{' '}
                  Email distribution will be an important tool to keep
                  interested stakeholders and the public informed on ARBS
                  progress, timing of deliverables, and opportunities for input
                  (e.g., public meetings/workshops).
                </Type>
                <Type paragraph>
                  In an effort to maximize public outreach, news/press releases
                  will be developed and issued by the Study Partners at key
                  points in the ARBS process, including:
                </Type>
                <ul>
                ...
                <Type paragraph>
                  ...
                  purposes and to solicit feedback/input. These
                  meetings/workshops will be publicized with news/press
                  releases, email notifications, Web site postings, targeted
                  invitations, and/or other methods (as appropriate). If
                  interested, please contact the Project Manager for the next
                  Public Meeting.
                </Type>
              </article>

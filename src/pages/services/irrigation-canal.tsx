            ...
            <ChildBox flex="40%">
              ...
              >
                ...
                <Type paragraph variant="body2" color="inherit">
                  Every year canals are cleaned during, and are to be out of
                  water during cleaning. Outage times listed are approximate.
                  Recovery time for water service is approximately 12 hours. To
                  see start and end dates and to find out more information about
                  these outages{' '}
                  <Link

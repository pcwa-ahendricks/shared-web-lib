...
import {type AwsNewsRelease} from '@lib/types/aws'
...
type Props = {
  err?: any
  media?: AwsNewsRelease
  publishedOn: string
}

const DynamicNewsReleasePage = ({media, err, publishedOn}: Props) => {
  ...
  const pageTitle = publishedOn ? `News Release ${publishedOn}` : ''
...
export const getStaticProps: GetStaticProps = async ({params}) => {
  try {
    ...
    const qs = new URLSearchParams({
      folderPath: `pcwa-net/newsroom/news-releases/${publishedOn}`,
    ...
    const mediaList: AwsNewsRelease[] = await fetcher(url)

...
const standards: Standard[] = [
  {
    ...
    revision: 'Revision 2',
    url:
      'https://cdn.cosmicjs.com/59642df0-b019-11ea-bbb7-b70da071f778-S112.R1.pdf',
  ...
  },
  {
    ...
    revision: 'Revision 2',
    url:
      'https://cdn.cosmicjs.com/5928d2a0-b019-11ea-bbb7-b70da071f778-S113.R1.pdf',
    approved: parse('06/12/2020', 'MM/dd/yyyy', new Date())
  },
  {
    id: 3,
    ...
    revision: 'Revision 2',
    url:
      'https://cdn.cosmicjs.com/595f7300-b019-11ea-bbb7-b70da071f778-S201.R1.pdf',
    approved: parse('06/12/2020', 'MM/dd/yyyy', new Date())
  },
  {
    id: 4,
    ...
    revision: 'Revision 2',
    url:
      'https://cdn.cosmicjs.com/59682590-b019-11ea-bbb7-b70da071f778-S202.R1.pdf',
    approved: parse('06/12/2020', 'MM/dd/yyyy', new Date())
  },
  {
    id: 5,
    ...
    revision: 'Revision 2',
    url:
      'https://cdn.cosmicjs.com/5962f570-b019-11ea-bbb7-b70da071f778-S203.R1.pdf',
    approved: parse('06/12/2020', 'MM/dd/yyyy', new Date())
  },
  {
    id: 6,
    ...
    revision: 'Revision 2',
    url:
      'https://cdn.cosmicjs.com/593b2220-b019-11ea-bbb7-b70da071f778-S207.R1.pdf',
    approved: parse('06/12/2020', 'MM/dd/yyyy', new Date())
  },
  {
    id: 7,
    ...
    revision: 'Revision 2',
    url:
      'https://cdn.cosmicjs.com/591b1700-b019-11ea-bbb7-b70da071f778-S301.R1.pdf',
    approved: parse('06/12/2020', 'MM/dd/yyyy', new Date())
  },
  {
    id: 8,
    ...
    revision: 'Revision 2',
    url:
      'https://cdn.cosmicjs.com/593f40d0-b019-11ea-bbb7-b70da071f778-S304R1.pdf',
    approved: parse('06/12/2020', 'MM/dd/yyyy', new Date())
  },
  {
    id: 9,
    ...
    revision: 'Revision 2',
    url:
      'https://cdn.cosmicjs.com/59511b20-b019-11ea-bbb7-b70da071f778-S305.R1.pdf',
    approved: parse('06/12/2020', 'MM/dd/yyyy', new Date())
  },
  {
    id: 10,
    ...
    revision: 'Revision 2',
    url:
      'https://cdn.cosmicjs.com/594cd560-b019-11ea-bbb7-b70da071f778-S306.R1.pdf',
    approved: parse('06/12/2020', 'MM/dd/yyyy', new Date())
  },
  {
    id: 11,

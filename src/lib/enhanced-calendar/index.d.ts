...
declare module '@lib/enhanced-calendar' {
  ...
  export type CalendarMouseHandler = (
  ...
  export class Calendar extends React.Component<
    CalendarSvgProps & Dimensions
  > {}
  export class EnhancedCalendar extends React.Component<
  ...
  export class CalendarCanvas extends React.Component<
    CalendarSvgProps & Dimensions
  > {}
  ...
  export class ResponsiveEnhancedCalendarCanvas extends React.Component<ResponsiveEnhancedCalendarCanvas> {}
}

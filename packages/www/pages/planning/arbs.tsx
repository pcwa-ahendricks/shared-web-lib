// cspell:ignore SSJRBS Cosumnes Subbasins USBR EDCWA brickards
...
import {ChildBox, ColumnBox} from '@components/boxes/FlexBox'
...
const ARBSPage = () => {
  ...
  const LIText = ({
    ...
    return (
      <ListItemText classes={{primary: classes.listItemText}} {...rest}>
        {children}
      </ListItemText>
    )
  }
      ...
      <MainBox>
        <NarrowContainer>
          ...
          <article>
            ...
            <Type paragraph>
              Water managers in the American River Basin continue to experience
              a growing imbalance between water demands and water supply due to
              a variety of factors, including population growth; increased
              ...
              and increasingly intense and more frequent extreme events
              (droughts and floods).
            </Type>
            <Type paragraph>
              ...
              and critical habitat within California’s Central Valley. The
              60,000 square mile study area for the SSJRBS encompasses all main
              tributaries within the Central Valley as well as the
              Sacramento-San Joaquin Delta (Delta), the largest estuary on the
              west coast of North America. The SSJRBS outlines potential impacts
              over a range of possible future climate conditions on various
              natural resources and presents portfolios of broad adaptive
              strategies for consideration by water agencies and other
              interests.
            </Type>
            <Type paragraph>
              ...
              basin-specific, integrated water management strategies to improve
              regional water supply reliability within the American River Basin,
              while improving the Reclamation’s flexibility in operating Folsom
              Reservoir to meet flow and water quality standards and protect
              endangered fishery species in the lower American River.
            </Type>
            <Type paragraph>
            ...
            <Type paragraph>
              ...
              improve the resolution of regional climate change data and develop
            ...
            <ul>
              <TypeBullet>
                ...
                the American River Basin over the data developed for the SSJRBS.
              </TypeBullet>
              <TypeBullet>
            ...
            <ul>
              ...
              <TypeBullet>
                ...
                operations will perform in the face of changing water realities
                and other impact identified in Section 9503(b)(3) of the SECURE
                Water Act, including the ability to deliver water; hydroelectric
                power generation; recreation; fish and wildlife habitat;
                applicable species listed as endangered, threatened, or
                candidate species and/or designated critical habitat under the
                Endangered Species Act of 1973; water quality issues (including
                salinity levels); flow and water dependent ecological
                resiliency; and flood control and/or management.
              </TypeBullet>
              <TypeBullet>
              ...
              <TypeBullet>
                ...
                including an analysis of all options in terms of their relative
                cost, environmental impact, risk, stakeholder response, or other
                common attributes.
              </TypeBullet>
            </ul>
            <Type paragraph>
              ...
              those of Reclamation and the CVP, and Study Partners are committed
              to pursuing integrated water management solutions that benefit all
              parties.
            </Type>
            ...
            <Type paragraph>
              ...
              River Basin – that is bounded by the Bear River to the north, the
              Cosumnes River to the south, the Sierra Nevada mountain range to
              the east, and the Feather and Sacramento Rivers to the west. The
              Study Area encompasses two parts:
            </Type>
            <ul>
              <TypeBullet>
                ...
                outside of the watershed that are served by Study Partners with
                American River water are also included in the Study Area.
              </TypeBullet>
              <TypeBullet>
                ...
                surface water from the American River, local water agencies use
            ...
            <Type paragraph>
              ...
              stakeholder and public participation at key points during the ARBS
              development process. Stakeholders and interested members of the
              public can be notified of public meetings/workshops via the ARBS
              Web site, or elect to sign up for email notifications here.{' '}
            ...
            <Type paragraph>
              In an effort to maximize public outreach, news/press releases will
              be developed and issued by the Study Partners at key points in the
              ARBS process, including:
            </Type>
            <ul>
            ...
            <Type paragraph>
              The Study Partners intend to hold public meetings/workshops at key
              points during development of the ARBS for informational purposes
              and to solicit feedback/input. These meetings/workshops will be
              publicized with news/press releases, email notifications, Web site
              postings, targeted invitations, and/or other methods (as
              appropriate). If interested, please contact the Project Manager

...
const ShutoffProtectionPage = () => {
  ...
  const documents: {language: Languages; Component: JSX.Element}[] = [
    {
      language: 'english',
      Component: (
        <Box key={0}>
          <article>
            ...
            <Type paragraph>
              ...
              within 60 days of the bill date. No penalties or charges accrue on
              a disputed bill until 10 working days after a response from the
              Agency.
            </Type>
            <Type paragraph>
            ...
            <Type paragraph>
              ...
              a customer can then have their bill reviewed by a supervisor or
              manager. If a customer is still dissatisfied with the outcome, the
              customer may request a review by the General Manager. The General
              Manager can correct any billing errors made by the Agency. If a
              resolution is not reached by the General Manager, a final review
              and decision will be made by the Agency Board of Directors.
            </Type>
            <Type variant="h4" gutterBottom>
            ...
            <Type paragraph>
              ...
              avoid disruption of service. PCWA will consider all circumstances
              surrounding the request and make a determination as to whether the
              deferred or alternate payment arrangement is warranted. The
              payment plan can either defer the amount due to a later date or
              provide for a payment schedule for the outstanding balance. A plan
              will require the account to be brought up to date in 60 days, but
              may not exceed 12 months from the original due date. To inquire
              about an alternate payment schedule, please call Customer Services
              at <MainPhone />.
            </Type>
          </article>
          <Spacing size="large" />
      ...
      Component: (
        <Box key={1}>
          <article>
            ...
            <Type paragraph>
              La ley de California ofrece opciones para que los clientes eviten
              la interrupción del servicio residencial de agua por falta de pago
              de su factura de agua. Estas opciones incluyen programas de pagos
              diferidos o pago alternativo, y apelar una factura de agua.
            </Type>
            <Type variant="h4" gutterBottom>
            ...
            <Type paragraph>
              ...
              facturas, dentro de los 60 días de la fecha de facturación. No se
              acumulan penalizaciones o cargos en una factura en disputa hasta
              10 días hábiles después de una respuesta de la Agencia.
            </Type>
            <Type paragraph>
            ...
            <Type paragraph>
              ...
              servicio al cliente, el cliente puede solicitar la revisión de la
              factura por parte de un supervisor o gerente. Si el cliente aún no
              está satisfecho con el resultado, puede solicitar una revisión por
              parte del Gerente General. El Gerente General puede corregir
              cualquier error de facturación cometido por la Agencia. Si el
              Gerente General no llega a una resolución, el Consejo de
            ...
            <Type paragraph>
              ...
              período de pago normal puede solicitar un plan de pago alternativo
              para evitar la interrupción del servicio. La Agencia de agua del
              Condado de Placer (PCWA) considerará todas las circunstancias que
              rodean la solicitud y tomará una determinación sobre si se
              justifica el acuerdo de pago diferido o alternativo. El plan de
              pago puede aplazar el monto adeudado a una fecha posterior o
              establecer un calendario de pagos para el saldo pendiente. Un plan
              requerirá que la cuenta se actualice en 60 días, pero no puede
              exceder los 12 meses a partir de la fecha de vencimiento original.
              Para averiguar sobre un calendario de pago alternativo, por favor
              llame a Servicio al Cliente <MainPhone />.
            </Type>
          </article>
          <Spacing size="large" />
      ...
      Component: (
        <Box key={2}>
          <article>
            ...
            <Type paragraph>
              캘리포니아 법에 따라 수도세 미납자에 대한 주거용 수도 공급 중단에
              대비한 방안이 마련되어 있습니다. 이는 납부 기한 연장을 요청하거나
              납부 일정을 변경, 수도 요금 재검토를 요청하는 경우를 포함합니다.
            </Type>
            <Type variant="h4" gutterBottom>
            ...
            <Type paragraph>
              ...
              기준으로 10일 이내에는 이의가 제기된 고지서에 대해 벌금 또는 추가
              금액이 청구되지 않습니다.
            </Type>
            <Type paragraph>
            ...
            <Type paragraph>
              ...
              또는 관리자에게 고지서 검토를 요청할 수 있습니다. 계속하여 결과를
              납득할 수 없는 경우, 총책임자에게 검토를 요청할 수 있습니다.
              총책임자는 기관 측 과실로 인한 모든 청구 오류를 수정할 수
              있습니다. 총책임자도 해결하지 못한 경우에는 기관 이사회에서 최종
              검토 및 결정을 내릴 것입니다.
            </Type>
            <Type variant="h4" gutterBottom>
            ...
            <Type paragraph>
              ...
              중단을 피하려면 납부 일정 변경을 요청할 수 있습니다. PCWA는 요청한
              건에 대한 모든 상황을 고려하여 기간 연장 또는 납부 일정 변경이
              타당한지 결정할 것입니다. 납부 일정을 원래 기한 보다 늦추거나 미납
              요금에 대한 납부 일정을 정할 수도 있습니다. 기한 연장 일정은 최대
              60일 이내로 정할 수 있으며 원래 기한으로부터 12개월을 초과할 수
              없습니다. 납부 일정 변경을 요청하려면 고객 지원 부서로 문의하시기
              바랍니다 <MainPhone />.
            </Type>
          </article>
          <Spacing size="large" />
